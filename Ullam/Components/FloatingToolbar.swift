        ...
        HStack(spacing: 0) {
            ...
            Button {
                ...
                Image(systemName: isListening ? "mic.fill" : "mic")
                    ...
                    .foregroundStyle(isListening ? .red : .white.opacity(0.45))
                    .frame(width: 34, height: 34)
                    .background(isListening ? Color.red.opacity(0.15) : .white.opacity(0.06))
                ...
                ForEach(ToolbarSection.allCases, id: \.self) { section in
                    Button {
                        ...
                        Text(section.rawValue)
                            ...
                            .foregroundStyle(activeSection == section ? .white : .white.opacity(0.4))
                            .padding(.horizontal, 14)
                            .padding(.vertical, 7)
                            .background(
                                Capsule()
                                    .fill(activeSection == section ? AppTheme.accent.opacity(0.35) : .white.opacity(0.06))
                            )
                    }
                    .buttonStyle(TBStyle())
                }
