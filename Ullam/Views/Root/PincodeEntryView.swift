        ...
        HStack(spacing: 20) {
            ForEach(0..<maxDigits, id: \.self) { index in
                ZStack {
                    ...
                    Circle()
                        .fill(index < enteredPincode.count ? dotActiveColor : dotInactiveColor)
                        .frame(width: 12, height: 12)
                }
                .frame(width: 24, height: 24)
                .animation(.easeOut(duration: 0.15), value: enteredPincode.count)
            }
        }
